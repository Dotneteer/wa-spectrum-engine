...
<div class="toolbar">
  ...
  <ToolbarIconButton iconName="restart" fill="lightgreen" title="Reset" size=22 highlightSize=26 />
  <ToolbarSeparator />
  <ToolbarIconButton iconName="debug" fill="lightgreen" title="Debug" size=20 highlightSize=24 />
  ...
  <ToolbarSeparator />
  <ToolbarIconButton iconName="keyboard" title="Toggle keyboard" />
  <ToolbarSeparator />
  <ToolbarIconButton iconName="shadow-screen" fill="#ff80ff" title="Toggle shadow screen" />
  <ToolbarIconButton iconName="beam-position" fill="#ff80ff" title="Show ULA position" />
</div>
