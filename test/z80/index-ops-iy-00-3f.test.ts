...
describe("N: Indexed ops (iy) 00-3f", () => {
  before(async () => {
  ...
  it("00: nop", () => {
    let s = testMachine.initCode([0xfd, 0x00]);
  ...
  it("01: ld bc,NN", () => {
    let s = testMachine.initCode([0xfd, 0x01, 0x12, 0xac]);
    ...
    expect(s.tactsL).toBe(14);
  });

  it("02: ld (bc),a", () => {
    let s = testMachine.initCode([0xfd, 0x02]);
  ...
  it("03: inc bc #1", () => {
    let s = testMachine.initCode([0xfd, 0x03]);
  ...
  it("04: inc b #1", () => {
    let s = testMachine.initCode([0xfd, 0x04]);
  ...
  it("05: dec b #1", () => {
    let s = testMachine.initCode([0xfd, 0x05]);
  ...
  it("06: ld b,N", () => {
    let s = testMachine.initCode([0xfd, 0x06, 0x26]);
    s = testMachine.run();
  ...
  it("07: rlca #1", () => {
    let s = testMachine.initCode([0xfd, 0x07]);
    s.a = 0x71;
    s = testMachine.run(s);
  ...
  it("08: ex af,af'", () => {
    let s = testMachine.initCode([0xfd, 0x08]);
    s.af = 0x71aa;
    s._af_ = 0xe318;
    s = testMachine.run(s);
  ...
  it("09: add iy,bc #1", () => {
    let s = testMachine.initCode([0xfd, 0x09]);
    s.iy = 0x1234;
    s.bc = 0x1102;
    s = testMachine.run(s);

    testMachine.shouldKeepRegisters("F, iy");
    testMachine.shouldKeepMemory();
    testMachine.shouldKeepSFlag();
    testMachine.shouldKeepZFlag();
    testMachine.shouldKeepPVFlag();
  ...
  it("09: add iy,bc #2", () => {
    ...
    expect(s.iy).toBe(0x0336);
    expect(s.pc).toBe(0x0002);
    expect(s.tactsL).toBe(15);
  });

  it("0a: ld a,(bc)", () => {
    let s = testMachine.initCode([0xfd, 0x0a]);
    s.bc = 0x1000;
    const m = testMachine.memory;
    m[0x1000] = 0x4c;
  ...
  it("0b: dec bc #1", () => {
    let s = testMachine.initCode([0xfd, 0x0b]);
  ...
  it("0c: inc c #1", () => {
    let s = testMachine.initCode([0xfd, 0x0c]);
  ...
  it("0d: dec c #1", () => {
    let s = testMachine.initCode([0xfd, 0x0d]);
  ...
  it("0e: ld c,N", () => {
    let s = testMachine.initCode([0xfd, 0x0e, 0x26]);
    s = testMachine.run();
  ...
  it("0f: rrca #1", () => {
    let s = testMachine.initCode([0xfd, 0x0f]);
    s.a = 0x70;
    s = testMachine.run(s);
  ...
  it("10: djnz #1", () => {
    let s = testMachine.initCode([0xfd, 0x10, 0x02]);
    s.b = 0x01;
    s = testMachine.run(s);
  ...
  it("10: djnz #2", () => {
    ...
    expect(s.tactsL).toBe(17);
  });

  it("11: ld de,NN", () => {
    let s = testMachine.initCode([0xfd, 0x11, 0x12, 0xac]);
  ...
  it("12: ld (de),a", () => {
    let s = testMachine.initCode([0xfd, 0x12]);
  ...
  it("13: inc de #1", () => {
    let s = testMachine.initCode([0xfd, 0x13]);
  ...
  it("14: inc d #1", () => {
    let s = testMachine.initCode([0xfd, 0x14]);
  ...
  it("15: dec d #1", () => {
    let s = testMachine.initCode([0xfd, 0x15]);
  ...
  it("16: ld d,N", () => {
    let s = testMachine.initCode([0xfd, 0x16, 0x26]);
    s = testMachine.run();
  ...
  it("17: rla #1", () => {
    let s = testMachine.initCode([0xfd, 0x17]);
    s.a = 0x81;
    s.f &= 0xfe;
    s = testMachine.run(s);
  ...
  it("18: jr e ", () => {
    let s = testMachine.initCode([0xfd, 0x18, 0x20]);
    s = testMachine.run(s);
  ...
  it("19: add iy,de #1", () => {
    let s = testMachine.initCode([0xfd, 0x19]);
    s.iy = 0x1234;
    s.de = 0x1102;
    s = testMachine.run(s);
  ...
  it("1a: ld a,(de)", () => {
    let s = testMachine.initCode([0xfd, 0x1a]);
    s.de = 0x1000;
    const m = testMachine.memory;
    m[0x1000] = 0x4c;
    s = testMachine.run(s, m);
  ...
  it("1b: dec de #1", () => {
    let s = testMachine.initCode([0xfd, 0x1b]);
  ...
  it("1c: inc e #1", () => {
    let s = testMachine.initCode([0xfd, 0x1c]);
  ...
  it("1d: dec e #1", () => {
    let s = testMachine.initCode([0xfd, 0x1d]);
  ...
  it("1e: ld e,N", () => {
    let s = testMachine.initCode([0xfd, 0x1e, 0x26]);
    s = testMachine.run();
  ...
  it("1f: rra #1", () => {
    let s = testMachine.initCode([0xfd, 0x1f]);
    s.a = 0x81;
    s.f &= 0xfe;
    s = testMachine.run(s);
  ...
  it("20: jr nz #1", () => {
    let s = testMachine.initCode([0xfd, 0x20, 0x04]);
    s.f |= FlagsSetMask.Z;
    s = testMachine.run(s);
  ...
  it("21: ld iy,NN", () => {
    let s = testMachine.initCode([0xfd, 0x21, 0x12, 0xac]);
    s = testMachine.run();

    testMachine.shouldKeepRegisters("iy");
    testMachine.shouldKeepMemory();
    expect(s.iy).toBe(0xac12);
    expect(s.pc).toBe(0x0004);
    expect(s.tactsL).toBe(14);
  });

  it("22: ld (NN),iy", () => {
    let s = testMachine.initCode([0xfd, 0x22, 0x00, 0x10]);
    s.iy = 0xa926;
    s = testMachine.run(s);
    const m = testMachine.memory;
  ...
  it("23: inc iy #1", () => {
    let s = testMachine.initCode([0xfd, 0x23]);
  ...
  it("23: inc iy #2", () => {
    ...
    testMachine.shouldKeepRegisters("iy");
    testMachine.shouldKeepMemory();
    expect(s.iy).toBe(0x0000);
    expect(s.pc).toBe(0x0002);
    expect(s.tactsL).toBe(10);
  });

  it("24: inc yh #1", () => {
    let s = testMachine.initCode([0xfd, 0x24]);

    s.yh = 0x43;
    s = testMachine.run(s);

    testMachine.shouldKeepRegisters("iy, F");
    testMachine.shouldKeepMemory();
    testMachine.shouldKeepCFlag();
    expect(s.f & FlagsSetMask.N).toBe(0);

    expect(s.yh).toBe(0x44);
    expect(s.pc).toBe(0x0002);
    expect(s.tactsL).toBe(8);
  });
  ...
  it("24: inc yh #4", () => {
    ...
    expect(s.f & FlagsSetMask.N).toBe(0);
    expect(s.f & FlagsSetMask.H).not.toBe(0);
    expect(s.yh).toBe(0x30);
    expect(s.pc).toBe(0x0002);
    expect(s.tactsL).toBe(8);
  });

  it("25: dec yh #1", () => {
    let s = testMachine.initCode([0xfd, 0x25]);
  ...
  it("25: dec yh #4", () => {
    ...
    expect(s.yh).toBe(0x1f);
    expect(s.pc).toBe(0x0002);
    expect(s.tactsL).toBe(8);
  });

  it("26: ld h,N", () => {
    let s = testMachine.initCode([0xfd, 0x26, 0x26]);
    s = testMachine.run();

    testMachine.shouldKeepRegisters("iy");
    testMachine.shouldKeepMemory();
    expect(s.yh).toBe(0x26);
    expect(s.pc).toBe(0x0003);
    expect(s.tactsL).toBe(11);
  });
  ...
  daaSamples.forEach((sm, index) => {
    it(`27: daa #${index + 1}`, () => {
      let s = testMachine.initCode([0xfd, 0x27]);
      s.a = sm.a;
      s.f =
  ...
  it("28: jr z #1", () => {
    let s = testMachine.initCode([0xfd, 0x28, 0x04]);
    s.f &= ~FlagsSetMask.Z;
    s = testMachine.run(s);
  ...
  it("29: add iy,iy #1", () => {
    let s = testMachine.initCode([0xfd, 0x29]);
    s.iy = 0x1000;
    s = testMachine.run(s);
  ...
  it("29: add iy,iy #2", () => {
    ...
    expect(s.iy).toBe(0x0468);
    expect(s.pc).toBe(0x0002);
    expect(s.tactsL).toBe(15);
  });

  it("2a: ld iy,(NN)", () => {
    let s = testMachine.initCode([0xfd, 0x2a, 0x00, 0x10]);
    const m = testMachine.memory;
    m[0x1000] = 0x34;
    m[0x1001] = 0x12;
    s = testMachine.run(s, m);
    ...
    testMachine.shouldKeepRegisters("iy");
    testMachine.shouldKeepMemory();
    expect(s.iy).toBe(0x1234);
    expect(s.pc).toBe(0x0004);
    expect(s.tactsL).toBe(20);
  });

  it("2b: dec iy #1", () => {
    let s = testMachine.initCode([0xfd, 0x2b]);
  ...
  it("2c: inc yl #1", () => {
    let s = testMachine.initCode([0xfd, 0x2c]);
  ...
  it("2c: inc yl #4", () => {
    ...
    expect(s.f & FlagsSetMask.N).toBe(0);
    expect(s.f & FlagsSetMask.H).not.toBe(0);
    expect(s.yl).toBe(0x30);
    expect(s.pc).toBe(0x0002);
    expect(s.tactsL).toBe(8);
  });

  it("2d: dec yl #1", () => {
    let s = testMachine.initCode([0xfd, 0x2d]);
  ...
  it("2d: dec yl #4", () => {
    ...
    expect(s.yl).toBe(0x1f);
    expect(s.pc).toBe(0x0002);
    expect(s.tactsL).toBe(8);
  });

  it("2e: ld yl,N", () => {
    let s = testMachine.initCode([0xfd, 0x2e, 0x26]);
    s = testMachine.run();

    testMachine.shouldKeepRegisters("iy");
    testMachine.shouldKeepMemory();
    expect(s.yl).toBe(0x26);
    expect(s.pc).toBe(0x0003);
    expect(s.tactsL).toBe(11);
  });

  it("2f: cpl", () => {
    let s = testMachine.initCode([0xfd, 0x2f]);
    s.a = 0x81;
    s = testMachine.run(s);
  ...
  it("30: jr nc #1", () => {
    let s = testMachine.initCode([0xfd, 0x30, 0x04]);
    s.f |= FlagsSetMask.C;
    s = testMachine.run(s);
  ...
  it("31: ld sp,NN", () => {
    let s = testMachine.initCode([0xfd, 0x31, 0x12, 0xac]);
  ...
  it("32: ld (NN),a", () => {
    let s = testMachine.initCode([0xfd, 0x32, 0x00, 0x10]);
    s.a = 0x4c;
    s = testMachine.run(s);
    const m = testMachine.memory;
  ...
  it("33: inc sp #1", () => {
    let s = testMachine.initCode([0xfd, 0x33]);
  ...
  it("34: inc (iy+D) #1", () => {
    let s = testMachine.initCode([0xfd, 0x34, 0x52]);
  ...
  it("34: inc (iy+D) #2", () => {
    let s = testMachine.initCode([0xfd, 0x34, 0xfe]);
    let m = testMachine.memory;
    s.iy = 0x1000;
    m[s.iy - 2] = 0x23;
    s = testMachine.run(s, m);
  ...
  it("35: dec (iy+D) #1", () => {
    let s = testMachine.initCode([0xfd, 0x35, 0x52]);
    let m = testMachine.memory;
    s.iy = 0x1000;
    m[s.iy + 0x52] = 0x23;
    s = testMachine.run(s, m);
  ...
  it("35: dec (iy+D) #2", () => {
    let s = testMachine.initCode([0xfd, 0x35, 0xfe]);
    let m = testMachine.memory;
    s.iy = 0x1000;
    m[s.iy - 2] = 0x23;
    s = testMachine.run(s, m);
  ...
  it("36: ld (iy+D),N #1", () => {
    let s = testMachine.initCode([0xfd, 0x36, 0x52, 0x23]);
    s.iy = 0x1000;
    s = testMachine.run(s);
    const m = testMachine.memory;
  ...
  it("36: ld (iy+D),N #2", () => {
    let s = testMachine.initCode([0xfd, 0x36, 0xfe, 0x23]);
    s.iy = 0x1000;
    s = testMachine.run(s);
    const m = testMachine.memory;
  ...
  it("37: scf", () => {
    let s = testMachine.initCode([0xfd, 0x37]);
    s.f &= 0xfe;
    s = testMachine.run(s);
  ...
  it("38: jr c #1", () => {
    let s = testMachine.initCode([0xfd, 0x38, 0x04]);
    s.f &= ~FlagsSetMask.C;
    s = testMachine.run(s);
  ...
  it("39: add iy,sp #1", () => {
    let s = testMachine.initCode([0xfd, 0x39]);
    s.iy = 0x1234;
    s.sp = 0x1102;
    s = testMachine.run(s);
  ...
  it("3a: ld a,(NN)", () => {
    let s = testMachine.initCode([0xfd, 0x3a, 0x00, 0x10]);
    let m = testMachine.memory;
    m[0x1000] = 0x4c;
    s = testMachine.run(s, m);
  ...
  it("3b: dec sp #1", () => {
    let s = testMachine.initCode([0xfd, 0x3b]);
  ...
  it("3c: inc a #1", () => {
    let s = testMachine.initCode([0xfd, 0x3c]);
  ...
  it("3d: dec a #1", () => {
    let s = testMachine.initCode([0xfd, 0x3d]);
  ...
  it("3e: ld a,N", () => {
    let s = testMachine.initCode([0xfd, 0x3e, 0x26]);
    s = testMachine.run();
  ...
  it("3f: ccf #1", () => {
    let s = testMachine.initCode([0xfd, 0x3f]);
    s.f &= 0xfe;
    s = testMachine.run(s);
